...
def process_song_file(cur, filepath):
    ...
    artist_data_columns = df[["artist_id", "artist_name", "artist_location", "artist_latitude", "artist_longitude"]]
    artist_data_replace_nan = artist_data_columns.replace({np.nan: None})
    artist_data = artist_data_replace_nan.values[0].tolist()
